...
vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await juna.getName(i + '@s.whatsapp.net')}\nFN:${await juna.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET: fariddewangga@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/cpm_jhon?igshid=MTNuMnE3aXlxcGxx\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
})
}
...
pathFile = await writeExif(media, { packname: options.packname ? options.packname : 'Junaa Bot', author: options.author ? options.author : '+6285894955362', categories: options.categories ? options.categories : [] })
